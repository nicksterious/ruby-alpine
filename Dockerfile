...
ENV PATH="/passenger/bin:$PATH" \
    ...
    DEV_PACKAGES="zlib-dev libxml2-dev libxslt-dev yaml-dev sqlite-dev postgresql-dev mysql-dev apache2-dev apr-util apr-util-dev mariadb-connector-c-dev mariadb-dev" \
